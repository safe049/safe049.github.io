...
一切非现实的东西都是现实的。因为非现实本身具有概念，而一旦作为思维的对象，就进入了思维之中而成为了思维的一部分，同时思维又是最现实的，所以思维使得非现实现实化，本质上成为了现实。

同时，物理现实与精神现实总被人们所隔开，我将对两者做出定义：

物理现实，为方便起见我们称其为：物在，而精神现实我们称其为：实在。实在是内在思维本身以及其在形而上层面的，亦即在思维内但不体现于物在的外化物，而物在指的是实在的物理外化物，可被感官以最直接的形式所感受，物在与实在的界限是不清的，两者可以互相干涉，两者的性质也极其相似，其中都能找到一定的内在思维的体现，也都能寻找到绝对概念，同时也都包含了概念，定义等。举例，时间，在物在与实在的界限就难以辨别，其通过对象的衰败在物在中得以体现，又以个体在内在思维中的外化得以体现，其可以说同时存在于两者之中。

对于实在对具体定义现实的尝试，数学是一个宏大的实践。内在思维外化出了数学以描述外在表象本身，且数学可描述一切外在表象，并可无限趋近于绝对概念亦或内在思维，但永远无法成为内在思维或绝对概念。我们在此文中不详细论述为何数学具有这样的与绝对概念和真理的隔绝性，因为这一点在数学中本身即有体现：哥德尔定理。换言之，数学是结构化的现实，但却无法把握现实中作为内在思维自身的那一部分。即，数学具有“隔实性”。
